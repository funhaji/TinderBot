...
export const cb = {
    ...
    profileEditField: (field) => `ped:${field}`,
    ...
    settingsVis: "set:vis",
    settingsRad: (meters) => `set:rad:${meters}`,
    ...
    setToggleSc: "set:sc",
    wizardGender: (g) => `wg:${g}`,
    wizardOrientation: (o) => `wor:${o}`,
    wizardLf: (lf) => `wlf:${lf}`,
    wizardSeekToggle: (g) => `wsk:${g}`,
    wizardSeekDone: "wsk:done",
    interestToggle: (key) => `int:${key}`,
...
export function settingsKeyboardFull(cfg, lang, prefs) {
    ...
    const kb = new InlineKeyboard()
        ...
        .row()
        .text(`${onOff(prefs.prefer_same_country)} ${t(lang, "settings.sameCountry")}`, cb.setToggleSc)
        .row()
...
export function homeKeyboard(lang) {
    return new InlineKeyboard()
...
export function swipeKeyboard(lang) {
    return new InlineKeyboard()
...
export function seekGenderKeyboard(lang, selected) {
    const kb = new InlineKeyboard();
    const opts = [
        { key: "m", fa: "مرد", en: "Men" },
...
export function wizardGenderKeyboard(lang) {
    return new InlineKeyboard()
...
export function wizardOrientationKeyboard(lang) {
    return new InlineKeyboard()
...
export function wizardAgeCategoryKeyboard(lang) {
    return new InlineKeyboard()
...
export function wizardAgePickKeyboard(lang, minAge, maxAge) {
    const kb = new InlineKeyboard();
    let col = 0;
...
export function wizardIranLocationKeyboard(lang) {
    const kb = new InlineKeyboard();
...
export function wizardLookingForKeyboard(lang) {
    return new InlineKeyboard()
...
export function wizardSeekKeyboard(lang, selected) {
    const kb = new InlineKeyboard();
    const opts = [
        { key: "m", fa: "مرد", en: "Men" },
        { key: "f", fa: "زن", en: "Women" },
