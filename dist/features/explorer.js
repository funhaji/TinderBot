...
export function formatDiscoverCaption(params) {
    ...
    if (viewer.location_lat != null &&
        viewer.location_lon != null &&
        target.location_lat != null &&
        target.location_lon != null) {
        const m = haversineMeters({ lat: viewer.location_lat, lon: viewer.location_lon }, { lat: target.location_lat, lon: target.location_lon });
...
export function registerExplorerCallbacks(bot, handlers) {
