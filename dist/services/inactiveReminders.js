 ...
 */
async function getInactiveUsersForReminder(days) {
 ...
 */
async function markReminderSent(userId, day) {
    await query(`
 ...
 */
async function getReminderMessage(day, lang) {
 ...
 */
async function isReminderEnabled(day) {
 ...
 */
async function sendRemindersForDay(bot, day) {
    try {
 ...
 */
export async function processInactiveUserReminders(bot) {
 ...
 */
export async function cleanupOldReminderRecords() {
    try {
        const res = await query(`
